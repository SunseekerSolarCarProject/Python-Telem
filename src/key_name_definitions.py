...
class TelemetryKey(Enum):
    ...
    ARRAY_ESTIMATE_WINDOW_W = ("Array_Estimate_Window_W", "W samples")
    ARRAY_ESTIMATE_SAMPLE_1_W = ("Array_Estimate_Sample_1_W", "W")
    ARRAY_ESTIMATE_SAMPLE_2_W = ("Array_Estimate_Sample_2_W", "W")
    ARRAY_ESTIMATE_SAMPLE_3_W = ("Array_Estimate_Sample_3_W", "W")
    ARRAY_ESTIMATE_SAMPLE_4_W = ("Array_Estimate_Sample_4_W", "W")
    ARRAY_ESTIMATE_SAMPLE_5_W = ("Array_Estimate_Sample_5_W", "W")
    ARRAY_ESTIMATE_WINDOW_COUNT = ("Array_Estimate_Window_Count", "frames")
    ARRAY_ESTIMATE_WINDOW_SPREAD_W = ("Array_Estimate_Window_Spread_W", "W")
    ARRAY_ESTIMATE_WINDOW_STDDEV_W = ("Array_Estimate_Window_StdDev_W", "W")
    ARRAY_ESTIMATE_FRAMES_TOTAL = ("Array_Estimate_Frames_Total", "frames")
    ARRAY_ESTIMATE_FRAMES_USABLE = ("Array_Estimate_Frames_Usable", "frames")
    ARRAY_ESTIMATE_FRAMES_REJECTED = ("Array_Estimate_Frames_Rejected", "frames")
    ARRAY_ESTIMATE_FRAME_USABLE_PCT = ("Array_Estimate_Frame_Usable_Pct", "%")
    ARRAY_ESTIMATE_PUBLISHED_COUNT = ("Array_Estimate_Published_Count", "estimates")
    ARRAY_ESTIMATE_UNAVAILABLE_COUNT = ("Array_Estimate_Unavailable_Count", "frames")
    ARRAY_ESTIMATE_AVAILABILITY_PCT = ("Array_Estimate_Availability_Pct", "%")
    ARRAY_ESTIMATE_MISSING_COUNT = ("Array_Estimate_Missing_Telemetry_Count", "frames")
    ARRAY_ESTIMATE_VOLTAGE_MISMATCH_COUNT = ("Array_Estimate_Voltage_Mismatch_Count", "frames")
    ARRAY_ESTIMATE_NEGATIVE_WINDOW_COUNT = ("Array_Estimate_Negative_Window_Count", "windows")
    ...
    NAV_ROUTE_DISTANCE_TRAVELED_MI = ("NAV_Route_Distance_Traveled", "mi")
    NAV_CHECKPOINT_DISTANCE_REMAINING_MI = ("NAV_Checkpoint_Distance_Remaining", "mi")
    NAV_CHECKPOINT_ETA = ("NAV_Checkpoint_ETA", "hh:mm:ss")
    NAV_RACE_MODE = ("NAV_Race_Mode", "")
    NAV_GPS_TRIP_DISTANCE_MI = ("NAV_GPS_Trip_Distance", "mi")
    NAV_SESSION_AVERAGE_SPEED_MPH = ("NAV_Session_Average_Speed", "mph")
    NAV_DAY_MOVING_AVERAGE_SPEED_MPH = ("NAV_Day_Moving_Average_Speed", "mph")
    NAV_DAY_MAX_SPEED_MPH = ("NAV_Day_Max_Speed", "mph")
    NAV_DAY_ELAPSED_TIME = ("NAV_Day_Elapsed_Time", "hh:mm:ss")
    NAV_DAY_MOVING_TIME = ("NAV_Day_Moving_Time", "hh:mm:ss")
    NAV_DAY_STOPPED_TIME = ("NAV_Day_Stopped_Time", "hh:mm:ss")
    NAV_FSGP_LAP_LENGTH_MI = ("NAV_FSGP_Lap_Length", "mi")
    NAV_FSGP_OFFICIAL_DISTANCE_MI = ("NAV_FSGP_Official_Distance", "mi")
    NAV_FSGP_DAY_DURATION_H = ("NAV_FSGP_Day_Duration", "h")
    NAV_FSGP_TIME_REMAINING = ("NAV_FSGP_Time_Remaining", "hh:mm:ss")
    NAV_FSGP_PROJECTED_TOTAL_LAPS = ("NAV_FSGP_Projected_Total_Laps", "laps")
    NAV_FSGP_PROJECTED_DISTANCE_MI = ("NAV_FSGP_Projected_Distance", "mi")
    ...
    NAV_CURRENT_LAP_DISTANCE_MI = ("NAV_Current_Lap_Distance", "mi")
    NAV_CURRENT_LAP_AVERAGE_SPEED_MPH = ("NAV_Current_Lap_Average_Speed", "mph")
    NAV_LAST_LAP_AVERAGE_SPEED_MPH = ("NAV_Last_Lap_Average_Speed", "mph")
    NAV_BEST_LAP_AVERAGE_SPEED_MPH = ("NAV_Best_Lap_Average_Speed", "mph")
    NAV_AVERAGE_LAP_SPEED_MPH = ("NAV_Average_Lap_Speed", "mph")
