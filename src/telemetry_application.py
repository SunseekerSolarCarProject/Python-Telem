    ...
    def init_units_and_keys(self):
        ...
        self.data_keys = [
            ...
            *solcast_keys_for_prefix("Solcast_Fcst_24h"),
            ...
            TelemetryKey.ARRAY_CURRENT_DIFFERENCE_A.value[0],
            TelemetryKey.ARRAY_ESTIMATED_CURRENT_A.value[0],
            TelemetryKey.ARRAY_POWER_BALANCE_W.value[0],
            TelemetryKey.ARRAY_ESTIMATED_POWER_W.value[0],
            TelemetryKey.ARRAY_ESTIMATED_POWER_KW.value[0],
            TelemetryKey.ARRAY_ESTIMATE_STATUS.value[0],
            ...
            TelemetryKey.ARRAY_ESTIMATE_WINDOW_COUNT.value[0],
            TelemetryKey.ARRAY_ESTIMATE_WINDOW_SPREAD_W.value[0],
            TelemetryKey.ARRAY_ESTIMATE_WINDOW_STDDEV_W.value[0],
            TelemetryKey.ARRAY_ESTIMATE_FRAMES_TOTAL.value[0],
            TelemetryKey.ARRAY_ESTIMATE_FRAMES_USABLE.value[0],
            TelemetryKey.ARRAY_ESTIMATE_FRAMES_REJECTED.value[0],
            TelemetryKey.ARRAY_ESTIMATE_FRAME_USABLE_PCT.value[0],
            TelemetryKey.ARRAY_ESTIMATE_PUBLISHED_COUNT.value[0],
            TelemetryKey.ARRAY_ESTIMATE_UNAVAILABLE_COUNT.value[0],
            TelemetryKey.ARRAY_ESTIMATE_AVAILABILITY_PCT.value[0],
            TelemetryKey.ARRAY_ESTIMATE_MISSING_COUNT.value[0],
