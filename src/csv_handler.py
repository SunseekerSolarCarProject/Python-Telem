...
class CSVHandler:
    ...
    def generate_primary_headers(self):
        ...
        ordered_keys = [
            ...
            TelemetryKey.NAV_SATS_VISIBLE.value[0], TelemetryKey.NAV_SATS_VISIBLE_VALID.value[0],
            TelemetryKey.NAV_SATS_VISIBLE_AGE_MS.value[0], TelemetryKey.NAV_SATS_USED.value[0],
            TelemetryKey.NAV_SATS_USED_VALID.value[0], TelemetryKey.NAV_SATS_USED_AGE_MS.value[0],
    ...
    def generate_training_headers(self):
        ...
        return [
            ...
            'BreakEven_Power_W',
            'BreakEvenSpeed',
            'Array_Estimate_Sample_1_W',
            'Array_Estimate_Sample_2_W',
            'Array_Estimate_Sample_3_W',
            'Array_Estimate_Sample_4_W',
            'Array_Estimate_Sample_5_W',
